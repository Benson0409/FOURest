            ...
            if (Input.touchCount > 0 && spawnObject != null)
            {
                ...
                if (Physics.Raycast(ray, out hit))
                {
                    ...
                    if (hit.transform.gameObject.tag == "colorMirrorRotate1")
                    {
                        ...
                        if (hit.transform.eulerAngles.y < 274.5f && hit.transform.eulerAngles.y > 269.5f)
                        {
                            //位置正確 紀錄狀況
                            correctRotate1 = true;
                        }
                    ...
                    if (hit.transform.gameObject.tag == "colorMirrorRotate2")
                    {
                        ...
                        if (hit.transform.eulerAngles.y < 37.5f && hit.transform.eulerAngles.y > 32.5f)
                        {
                            //位置正確 紀錄狀況
                            correctRotate2 = true;
                        }
                    ...
                    if (hit.transform.gameObject.tag == "colorMirrorRotate3")
                    {
                        ...
                        if (hit.transform.eulerAngles.y < 165.5f && hit.transform.eulerAngles.y > 159.5f)
                        {
                            //位置正確 紀錄狀況
                            correctRotate3 = true;
                        }
